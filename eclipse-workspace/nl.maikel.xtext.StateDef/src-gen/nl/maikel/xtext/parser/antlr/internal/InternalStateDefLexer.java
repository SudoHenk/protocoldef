...
public class InternalStateDefLexer extends Lexer {
    ...
    public final void mT__22() throws RecognitionException {
        try {
            int _type = T__22;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:19:7: ( 'any' )
            // InternalStateDef.g:19:9: 'any'
            {
            match("any"); 
    ...
    public final void mT__23() throws RecognitionException {
        try {
            int _type = T__23;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:20:7: ( 'received' )
            // InternalStateDef.g:20:9: 'received'
            {
            match("received"); 
    ...
    public final void mT__24() throws RecognitionException {
        try {
            int _type = T__24;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:21:7: ( 'messages' )
            // InternalStateDef.g:21:9: 'messages'
            {
            match("messages"); 
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:22:7: ( 'sent' )
            // InternalStateDef.g:22:9: 'sent'
            {
            match("sent"); 
    ...
    public final void mT__26() throws RecognitionException {
        try {
            int _type = T__26;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:23:7: ( 'go' )
            // InternalStateDef.g:23:9: 'go'
            {
            match("go"); 
    ...
    public final void mT__27() throws RecognitionException {
        try {
            int _type = T__27;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:24:7: ( 'message' )
            // InternalStateDef.g:24:9: 'message'
            {
            match("message"); 
    ...
    public final void mT__28() throws RecognitionException {
        try {
            int _type = T__28;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:25:7: ( 'struct' )
            // InternalStateDef.g:25:9: 'struct'
            {
            match("struct"); 
    ...
    public final void mT__36() throws RecognitionException {
        try {
            int _type = T__36;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:33:7: ( ']' )
            // InternalStateDef.g:33:9: ']'
            {
            match(']'); 
    ...
    public final void mT__37() throws RecognitionException {
        try {
            int _type = T__37;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:34:7: ( 'enum' )
            // InternalStateDef.g:34:9: 'enum'
            {
            match("enum"); 
    ...
    public final void mT__39() throws RecognitionException {
        try {
            int _type = T__39;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:36:7: ( ')' )
            // InternalStateDef.g:36:9: ')'
            {
            match(')'); 
    ...
    public final void mRULE_HEX() throws RecognitionException {
        try {
            int _type = RULE_HEX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:1269:10: ( '0x' ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )* )
            // InternalStateDef.g:1269:12: '0x' ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )*
            {
            match("0x"); 

            // InternalStateDef.g:1269:17: ( 'a' .. 'f' | 'A' .. 'F' | '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_DATATYPE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:1271:15: ( ( 'uint' ( '8' | '16' | '24' ) | 'opaque' ) )
            // InternalStateDef.g:1271:17: ( 'uint' ( '8' | '16' | '24' ) | 'opaque' )
            {
            // InternalStateDef.g:1271:17: ( 'uint' ( '8' | '16' | '24' ) | 'opaque' )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalStateDef.g:1271:18: 'uint' ( '8' | '16' | '24' )
                    {
                    match("uint"); 

                    // InternalStateDef.g:1271:25: ( '8' | '16' | '24' )
                    int alt2=3;
                    switch ( input.LA(1) ) {
                    case '8':
                        {
                    ...
                    break;
                case 2 :
                    // InternalStateDef.g:1271:41: 'opaque'
                    {
                    match("opaque"); 
    ...
    public final void mRULE_ENUMNAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:1273:15: ( ( 'a' .. 'z' | '_' )+ )
            // InternalStateDef.g:1273:17: ( 'a' .. 'z' | '_' )+
            {
            // InternalStateDef.g:1273:17: ( 'a' .. 'z' | '_' )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:1275:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalStateDef.g:1275:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalStateDef.g:1275:11: ( '^' )?
            int alt5=2;
            ...
            // InternalStateDef.g:1275:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:1277:10: ( ( '0' .. '9' )+ )
            // InternalStateDef.g:1277:12: ( '0' .. '9' )+
            {
            // InternalStateDef.g:1277:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalStateDef.g:1277:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:1279:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalStateDef.g:1279:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalStateDef.g:1279:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalStateDef.g:1279:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalStateDef.g:1279:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
                    ...
                    break;
                case 2 :
                    // InternalStateDef.g:1279:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalStateDef.g:1279:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:1281:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalStateDef.g:1281:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalStateDef.g:1281:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:1283:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalStateDef.g:1283:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalStateDef.g:1283:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:1285:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalStateDef.g:1285:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalStateDef.g:1285:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt15=0;
            loop15:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalStateDef.g:1287:16: ( . )
            // InternalStateDef.g:1287:18: .
            {
            matchAny(); 
    ...
    static final String DFA16_eotS =
        "\1\uffff\1\45\1\uffff\2\45\1\uffff\6\45\4\uffff\1\41\5\uffff\1\75\3\45\1\41\2\uffff\3\41\2\uffff\3\45\3\uffff\2\45\1\uffff\6\45\1\120\14\uffff\2\45\4\uffff\3\45\1\126\6\45\1\135\1\45\1\uffff\5\45\1\uffff\1\144\2\45\1\147\1\45\1\151\1\uffff\6\45\1\uffff\1\162\1\45\1\uffff\1\45\1\uffff\1\45\1\166\2\46\4\45\1\uffff\1\175\2\45\1\uffff\3\166\1\u0080\1\u0082\1\u0083\1\uffff\2\45\1\uffff\1\u0086\2\uffff\1\45\1\u0088\1\uffff\1\45\1\uffff\1\u008a\1\uffff";
